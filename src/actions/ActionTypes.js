...
export const MEMO_EDIT_POST = "MEMO_EDIT_POST";
export const MEMO_EDIT_POST_SUCCESS = "MEMO_EDIT_POST_SUCCESS";
export const MEMO_EDIT_POST_FAILURE = "MEMO_EDIT_POST_FAILURE";
